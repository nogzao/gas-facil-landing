...
const CTASection: React.FC = () => {
  return (
    <section className="py-16 px-4 relative" id="contato">
            ...
            <div className="md:w-1/2">
              <div className="relative">
                ...
                <img 
                  ...
                  alt="Família feliz com água quente após conserto de aquecedor" 
                ...
                <div className="absolute -bottom-4 -right-4 bg-white px-4 py-3 rounded-lg shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gasfacil-blue">
                      +25 novos clientes hoje
                    </span>
                  </div>
                </div>
              </div>
